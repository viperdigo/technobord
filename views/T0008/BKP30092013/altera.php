...
//Dados
$dadosCabecalho         =   $obj->retornaCabecalho($codigoRomaneio, $codigoCliente,$anoRomaneio);
$dadosDetalhes          =   $obj->retornaDetalhes($codigoRomaneio,$codigoCliente, $anoRomaneio);
