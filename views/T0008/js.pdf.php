...
class PDF extends FPDF
{
    ...
    function ChapterBody()
    {
        ...
        //Dados
        $dadosCabec = $obj->retornaDadosCabecPDF($this->codigoRomaneio, $this->codigoCliente, $this->ano);
        $dadosDet = $obj->retornaDadosDetPDF($this->codigoRomaneio, $this->codigoCliente, $this->ano);
...
$pdf = new PDF("L");
$pdf->SetTitle("Romaneio");
$pdf->PrintChapter(1, 'Romaneio', '');
$pdf->Output();
