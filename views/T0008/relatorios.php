...
if (($dataInicio == 'null') || (empty($dataInicio)))
    ...
    $dataInicio = $obj->formataDataViewFix($dataInicio);

if (($dataFim == 'null') || (empty($dataFim)))
    $dataFim = $ultimoDiaMes . "/" . date("m/Y");
else
    $dataFim = $obj->formataDataViewFix($dataFim);
...
<div class="conteudo_16">
    ...
    foreach ($dados as $campos => $valores) {
        ...
        <div class="conteudo_16 linha" style="border: 1px solid #D3D3D3;">
            ...
            <div class="grid_3">
                <label class="codigoRomaneio" id="lRomaneio"
                       style="margin-left: 50px;"><?php echo $valores['codigoRomaneio']; ?></label>
