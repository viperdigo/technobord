                        ...
                        <tr> 
                            ...
                            <td class="acoes">
                                <ul class="ui-widget ui-helper-clearfix" id="icons">
                                    ...
                                    <li title="Imprimir"    class="ui-state-default ui-corner-all"          ><a href="<?php echo ROUTER?>js.pdf&codigoRomaneio=<?php echo $valores['CodigoRomaneio'];?>&codigoCliente=<?php echo $valores['CodigoCliente']?>&ano=<?php echo $valores['AnoRomaneio']?>" target="_blank"   ><span class="ui-icon ui-icon-print"></span></li>
                                </ul>
                            </td> 
                        </tr>
            <?php   }  ?>
