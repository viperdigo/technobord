...
if (!empty($_POST)) {
    ...
    $desenho = $_POST['T004_desenho'];

    $dados = $obj->retornaDados($codigoRomaneio, $dataRomaneio, $nomeCliente, $corte, $desenho, $ano);
} else {
    //Sem Filtro
...
<div id="barra-botoes">
    ...
    <a href="<?php echo ROUTER; ?>relatorios" class="ui-state-default ui-corner-all botoes-links"> <span
                class="ui-icon ui-icon-note">         </span>Relatórios</a>
    <hr>
</div>
<div id="barra-filtros">
    <form action="" method="post">
        <div class="conteudo_16">
            ...
            <div class="grid_2">
                <label>Desenho</label>
                <input type="text" name="T004_desenho" value="<?php echo $desenho ?>"/>
            </div>
            <div class="grid_2">
                <label>Ano</label>
                ...
                <td class="acoes">
                    <ul class="ui-widget ui-helper-clearfix" id="icons">
                        <li title="Alterar" class="ui-state-default ui-corner-all"><a
                                    href="<?php echo ROUTER ?>altera&codigoRomaneio=<?php echo $valores['CodigoRomaneio']; ?>&codigoCliente=<?php echo $valores['CodigoCliente'] ?>&anoRomaneio=<?php echo $valores['AnoRomaneio'] ?>"><span
                                        class='ui-icon ui-icon-pencil'></span></a></li>
                        <li title="Imprimir" class="ui-state-default ui-corner-all"><a
                                    href="<?php echo ROUTER ?>js.pdf&codigoRomaneio=<?php echo $valores['CodigoRomaneio']; ?>&codigoCliente=<?php echo $valores['CodigoCliente'] ?>&ano=<?php echo $valores['AnoRomaneio'] ?>"
                                    target="_blank"><span class="ui-icon ui-icon-print"></span></li>
                    </ul>
                </td>
            </tr>
        <?php } ?>
