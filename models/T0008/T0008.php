<?php                                                                               
    ...
    {                                                                               
        ...
        public function retornaDados($codigoRomaneio, $dataRomaneio, $nomeCliente, $corte, $desenho, $ano)
        {
            //Formata data para 2012-01-01
            $dataRomaneio   =   $this->formataDataView($dataRomaneio);
...
//            echo $sql;
        ...
        public function retornaClientes($codigoCliente)
        {
